        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-start">
            <div className="text-center lg:text-left">
              ...
              >
                We are Grox Media — a Pune-based website development company
        ...
        <div className="mx-auto max-w-6xl px-6">
          <motion.div {...fadeUp} className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-500">
              While we are based in Pune, we serve clients across major
        ...
        <div className="mx-auto max-w-4xl px-6">
          <motion.div {...fadeUp}>
            <h2 className="text-2xl sm:text-3xl font-bold text-[#111827] mb-6">
              About Grox Media — Website Development Company in Pune
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Grox Media is a website development company based in Pune,
                serving clients across Pune, Gurgaon, Noida, Delhi, and Mumbai.
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Yes. While we are based in Pune, we serve clients across Gurgaon, Noida, Delhi, Mumbai, and all over India. Most of our communication happens over calls and video meetings — location is never a barrier.",
              },
              {
