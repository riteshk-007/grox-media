            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-groxBlue via-blue-700 to-groxOrange text-white">
                ...
                <div className="absolute inset-0 opacity-10">
                    <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <pattern id="hero-services-grid" width="50" height="50" patternUnits="userSpaceOnUse">
                                <path
                                    d="M 50 0 L 0 0 0 50"
                                    fill="none"
                ...
                <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 relative z-10">
                    ...
                    >
                        <h1 className="mt-6 text-4xl md:text-6xl font-extrabold leading-tight">
                            ...
                            <span className="block text-groxOrange mt-2">That Drive Growth</span>
                        </h1>
                        ...
                        <div className="mt-8 flex flex-wrap gap-4">
                            <Link href="#web-designing" className="px-6 py-3 bg-white text-groxBlue font-semibold hover:bg-gray-100 transition-all shadow-lg">
                                Web Development
                            </Link>
                            <Link href="#digital-marketing" className="px-6 py-3 bg-white/10 backdrop-blur text-white border-2 border-white/30 font-semibold hover:bg-white/20 transition-all">
                                Digital Marketing
                            </Link>
                            <Link href="#graphic-design" className="px-6 py-3 bg-white/10 backdrop-blur text-white border-2 border-white/30 font-semibold hover:bg-white/20 transition-all">
                                Graphic Design
                            </Link>
                            <Link href="#mvp-development" className="px-6 py-3 bg-white/10 backdrop-blur text-white border-2 border-white/30 font-semibold hover:bg-white/20 transition-all">
                                MVP Development
                            </Link>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-6">
                    ...
                    {services.map((s, idx) => (
                        ...
                        >
                            <div className={`order-2 ${idx % 2 === 0 ? 'md:order-1' : 'md:order-2'}`}>
                                ...
                                <p className="text-gray-700 leading-7 text-lg mb-6">{s.description}</p>
                                {s.features && (
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Link href="/contact" className="inline-block bg-groxBlue text-white px-6 py-3 font-semibold hover:bg-blue-700 transition-all shadow-md">
                                        Talk to us about {s.title}
                                    </Link>
                                    <Link href="/portfolio" className="inline-block border-2 border-gray-300 px-6 py-3 font-semibold hover:border-groxBlue hover:text-groxBlue transition-all">
                                        See our work
                                    </Link>
                                </div>
                            </div>
                ...
                <section className="mt-24">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            { t: 'Discovery', d: 'We scope goals, audience, and success metrics to ensure alignment.' },
                            { t: 'Design & Build', d: 'Ship in short sprints with clear demos and continuous feedback.' },
                            { t: 'Launch & Grow', d: 'Track conversions and keep improving performance post-launch.' },
                        ].map((step, idx) => (
                            <motion.div
                                key={step.t}
                                initial={{ opacity: 0, y: 20 }}
                            ...
                            >
                                ...
                                <h3 className="font-bold text-xl text-gray-900 mb-2 group-hover:text-groxBlue transition-colors">{step.t}</h3>
                ...
                <section className="mt-16 bg-blue-50 border-l-4 border-groxBlue p-8">
                    <h2 className="text-2xl font-bold text-gray-900 mb-3">How We Price</h2>
                    <p className="text-gray-700 text-lg leading-relaxed">
                        Fixed-price for clear scope. Monthly retainers for ongoing SEO/Ads/updates. Every project starts with discovery to reduce surprise and risk.
                    </p>
                </section>
                        ...
                        {faqs.map((f, i) => (
                            <details key={i} className="p-6 group open:bg-gray-50">
                                <summary className="cursor-pointer font-semibold text-lg text-gray-900 list-none flex justify-between items-center">
                                    <span>{f.q}</span>
                                    <span className="text-groxBlue text-2xl transition group-open:rotate-180">▾</span>
                                </summary>
