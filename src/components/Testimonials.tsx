...
const testimonials = [
    {
        ...
        company: "MonarkFX",
        role: "Founder & CEO",
        quote: "Professional and timely delivery. The website exceeded our expectations.",
    },
    {
        name: "Sanjeev Kumar",
        company: "EDAWS",
    ...
    },
    {
        ...
        company: "TechFlow",
        role: "CTO",
        quote: "GroxMedia transformed our digital presence. The team is incredibly talented.",
    },
    {
        name: "Priya Patel",
        company: "DesignStudio",
        role: "Creative Director",
        quote: "A perfect blend of creativity and technical expertise. Loved working with them.",
    },
];
        ...
        <section className="py-24 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                    Don&apos;t just take our word for it. Here&apos;s what our clients have to say about their experience with GroxMedia.
                </p>
            </div>
