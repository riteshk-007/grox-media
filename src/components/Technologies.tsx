...
const Technologies = () => {
  return (
    <section className="md:py-16 py-10 bg-groxBlue text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Powered by{" "}
            <span className="text-groxOrange">Modern Technologies</span>
          </h2>
          <p className="text-blue-100 max-w-2xl mx-auto text-lg">
            We use the latest tools and frameworks to build scalable, secure,
