  ...
  return (
    <section className="w-full max-w-full overflow-x-hidden py-10 md:py-14">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-center text-2xl sm:text-3xl font-extrabold leading-snug text-[#111827] md:text-4xl md:leading-snug">
        ...
        <div className="mt-12 grid gap-10 md:grid-cols-2 md:gap-x-8 md:gap-y-12">
          {techCategories.map((category) => (
            ...
            >
              <h3 className="mb-5 text-sm sm:text-base font-bold uppercase tracking-wider text-groxBlue">
                {category.title}
              </h3>
