...
const FloatingContactButton = () => {
  ...
  const whatsappMessage =
    "Hi! I'm interested in CodeXprime IT services. Can you help me?";
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        <button
          onClick={toggleMenu}
          className={`hidden md:flex w-14 h-14 rounded shadow-lg hover:shadow-xl transition-all duration-300  items-center justify-center border ${
            isOpen
