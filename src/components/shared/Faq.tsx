...
const DEFAULT_FAQS: FaqItem[] = [
    {
        question: 'What IT services does GroxMedia offer?',
        answer: 'GroxMedia provides web design, web development, digital marketing, MVP development, and graphic design services for businesses of all sizes.'
    },
    {
    ...
    {
        question: 'Which modern technologies does GroxMedia use for web development?',
        answer: 'We use JavaScript, TypeScript, ReactJS, Next.js, Node.js, Express, and modern frameworks for building scalable websites.'
    },
    {
    ...
    {
        question: 'Can GroxMedia build applications using modern tech stacks?',
        answer: 'Yes, we develop modern apps using GraphQL APIs, Prisma ORM for databases, and state management libraries like Redux Toolkit.'
    },
    {
        question: 'What does GroxMedia’s digital marketing cover?',
    ...
    },
    {
        ...
        question: 'Does GroxMedia use DevOps tools like GitHub Actions, Nginx, and Docker?',
        ...
        answer: 'Yes, apart from advanced stacks, we also provide WordPress development for businesses.'
    }
]
        ...
        <section className="w-full max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="space-y-4">
                {visibleFaqs.map((f, idx) => (
                    <div key={idx} className="p-6 bg-white border border-gray-200 hover:border-groxBlue transition-colors duration-300">
                        <div className="flex items-start gap-4">
                            <div className="mt-1 text-groxBlue">
                                <Plus className="w-5 h-5" />
                            </div>
                            <div>
                                <h3 className="font-bold text-gray-900 text-lg mb-2">{f.question}</h3>
