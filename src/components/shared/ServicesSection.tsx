...
export const services: Array<{
    ...
    Icon?: IconType;
}> = [
        {
            ...
            description: 'Modern, high-performance websites built with cutting-edge technologies for maximum impact.',
        ...
        },
        {
            ...
            description: 'Data-driven marketing strategies that grow your brand and drive measurable results.',
            features: ['SEO & Technical SEO', 'Social Media Marketing', 'Google & Meta Ads', 'Content Strategy'],
            Icon: FiTrendingUp,
        },
        {
            id: 'graphic-design',
            title: 'Graphic Design',
            description: 'Stunning visual designs that capture attention and communicate your brand story.',
            features: ['Logo & Branding', 'UI/UX Design', 'Print & Digital', 'Brand Guidelines'],
            Icon: FiPenTool,
        },
        {
            id: 'mvp-development',
            title: 'MVP Development',
            description: 'Fast-track your product launch with rapid MVP development and validation.',
            features: ['Rapid Prototyping', 'Core Features', 'User Testing', 'Agile Development'],
            Icon: FiZap,
        },
    ];
